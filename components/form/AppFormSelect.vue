<template>
    <div :class="{
        ...
        <div class="app-form-input-content">
            <PrimeSelect :modelValue="props.modelValue" @change="onChange"
                :placeholder="props.placeholder" @focus="focused = true" @blur="focused = false"
                :disabled="props.disabled" :options="props.options" optionLabel="label" />
        </div>
...
import type { IOptions } from "~/types/form";

const PrimeSelect = defineAsyncComponent(() => import("primevue/select"));
